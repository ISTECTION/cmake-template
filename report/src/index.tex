...
В качестве примера приведена простая программа на языке C++ (Листинг~\ref{lst:simple_code}).
\lst{cpp}{\abspath cpp/main.cpp}
\captionof{listing}{Простая программа на C++}
